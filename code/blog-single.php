        ...
        <div class="row">
          <div class="col-md-12 col-lg-8">
            <div class="title-single-box">
              <h1 class="title-single">Couverture de livre Deisgn</h1>
              <span class="color-text-a">Nouvelles unique.</span>
            </div>
          </div>
              ...
              <ul class="list-comments">
                <li>
                  ...
                  <div class="comment-details">
                    <h4 class="comment-author">Abdoussalam TINE</h4>
                    <span>05 Avril 2021</span>
